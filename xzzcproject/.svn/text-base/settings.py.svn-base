# Django settings for xzzcproject project.
...
SECRET_KEY = 'xb%m67if0jz%+kwoqjqthfa6r-07@a-)qc^_&amp;0j7dj4-7kz0in'
...
ROOT_URLCONF = 'xzzcproject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'xzzcproject.wsgi.application'
